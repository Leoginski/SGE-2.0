...
public class RelatorioPropostaNomesController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String relatorio = getServletContext().getRealPath("\\WEB-INF\\classes\\Reports")+"\\reportPropostaNomes.jasper";
            JasperPrint jp = JasperFillManager.fillReport(relatorio, parametros, conexao);
            byte[] relat = JasperExportManager.exportReportToPdf(jp);
            response.setHeader("Content-Disposition", "attachment;filename=" + "reportPropostaNomes"+".pdf");
