 ...
 * @author Math
 */
@WebServlet(name = "RelatorioAdministradorController", urlPatterns = {"/RelatorioAdministradorController"})
public class RelatorioAdministradorController extends HttpServlet {
