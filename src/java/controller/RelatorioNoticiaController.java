 ...
 * @author Math
 */
@WebServlet(name = "RelatorioNoticiaController", urlPatterns = {"/RelatorioNoticiaController"})
public class RelatorioNoticiaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nomeRelatorio = "Noticia";
            String pData = request.getParameter("dataNoticia");
        ...
        try{
            ...
            request.setAttribute("noticias", NoticiaDAO.getAllNoticias());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioNoticiaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
