...
<html>
    ...
    <main>
        <form action="RelatorioNoticiaController?acao=exibirRelatorio" method="post" name="frmRelatorioNoticia">
        <div class="input-field row">
            <select name="dataNoticia" <c:if test="${operacao == 'Excluir'}"> disabled</c:if>>
                <option value="" <c:if test="${local.capacidade == null}"> selected</c:if>></option>
                <c:forEach items="${noticias}" var="noticia">
                    <option value="${noticia.data}">
                    ${noticia.data}
                    </option>  
                </c:forEach>
            </select>
