...
<html>
    <head>
        <title>Relatorio Administradores</title>
        <!--jQuery-->
    ...
    <main>
        <form action="RelatorioAdministradorController?acao=exibirRelatorio" method="post" name="frmRelatorioAdministrador">
        <div class="input-field row">
            <select name="nomeAdministrador" <c:if test="${operacao == 'Excluir'}"> disabled</c:if>>
                <option value="" <c:if test="${administrador.nome == null}"> selected</c:if>></option>
                <c:forEach items="${administradores}" var="administrador">
                    <option value="${administrador.nome}">
                    ${administrador.nome}
                    </option>  
                </c:forEach>
                        </select>
